...
<table class="box" border="0" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td class="smheading" align="center" width="250"><a class="smheading" href="./?p=maps&amp;filter=mapfile&amp;sort='.InvertSort('mapfile', $filter, $sort).'">Map Name</a>'.SortPic('mapfile', $filter, $sort).'</td>
    <td class="smheading" align="center" width="150"><a class="smheading" href="./?p=maps&amp;filter=matchcount&amp;sort='.InvertSort('matchcount', $filter, $sort).'">Matches</a>'.SortPic('matchcount', $filter, $sort).'</td>
    <td class="smheading" align="center"><a class="smheading" href="./?p=maps&amp;filter=frags&amp;sort='.InvertSort('frags', $filter, $sort).'">Avg. Frags</a>'.SortPic('frags', $filter, $sort).'</td>
    <td class="smheading" align="center" width="100"><a class="smheading" href="./?p=maps&amp;filter=matchscore&amp;sort='.InvertSort('matchscore', $filter, $sort).'">Avg. Score</a>'.SortPic('matchscore', $filter, $sort).'</td>
